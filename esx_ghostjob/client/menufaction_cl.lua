          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_ghost:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_ghost:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_ghost:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                TriggerServerEvent('esx_ghost:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenBodySearchMenu(player)
  ...
  ESX.TriggerServerCallback('esx_ghost:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_ghost:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_ghost:getVehicleInfos', function(infos)
...
RegisterNetEvent('esx_ghost:handcuff')
AddEventHandler('esx_ghost:handcuff', function()
...
RegisterNetEvent('esx_ghost:drag')
AddEventHandler('esx_ghost:drag', function(cop)
...
RegisterNetEvent('esx_ghost:putInVehicle')
AddEventHandler('esx_ghost:putInVehicle', function()
...
RegisterNetEvent('esx_ghost:OutVehicle')
AddEventHandler('esx_ghost:OutVehicle', function(t)
...
Citizen.CreateThread(function()
    while true do
		...
		if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'ghost' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bandits_actions') and (GetGameTimer() - GUI.Time) > 150 then
		   OpenBanditsMenu()
        end 
    end
end)
